    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/reports/patients/**").hasAnyRole(ADMIN_ROLE, DOCTOR_ROLE, PATIENT_ROLE)
                        .requestMatchers(HttpMethod.GET, "/reports/doctors/**").hasAnyRole(ADMIN_ROLE, DOCTOR_ROLE)
                        .requestMatchers(HttpMethod.GET, "/reports/clinic/**").hasRole(ADMIN_ROLE)
